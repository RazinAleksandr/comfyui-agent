...
See /root/workspace/avatar-factory/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /root/workspace/avatar-factory/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /root/workspace/avatar-factory/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /root/workspace/avatar-factory/.claude/get-shit-done/templates/discovery.md
...
Use /root/workspace/avatar-factory/.claude/get-shit-done/templates/discovery.md.
