...
- Usage: Reference from command with `@/root/workspace/avatar-factory/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /root/workspace/avatar-factory/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /root/workspace/avatar-factory/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
