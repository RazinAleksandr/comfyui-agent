...
<!-- For checkpoint task examples and patterns, see @/root/workspace/avatar-factory/.claude/get-shit-done/references/checkpoints.md -->
...
See `/root/workspace/avatar-factory/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/root/workspace/avatar-factory/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/root/workspace/avatar-factory/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
