...
You have a persistent Persistent Agent Memory directory at `/Users/aleksandrrazin/work/opensource-research/comfyui-agent/.claude/agent-memory/code-agent/`. Its contents persist across conversations.
