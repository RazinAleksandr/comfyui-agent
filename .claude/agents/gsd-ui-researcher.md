...
Use template from `/root/workspace/avatar-factory/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/root/workspace/avatar-factory/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/root/workspace/avatar-factory/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
