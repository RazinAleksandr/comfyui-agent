...
You have a persistent Persistent Agent Memory directory at `/root/workspace/avatar-factory/.claude/agent-memory/code-critic/`. Its contents persist across conversations.
