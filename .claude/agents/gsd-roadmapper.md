...
Reference full template: `/root/workspace/avatar-factory/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/root/workspace/avatar-factory/.claude/get-shit-done/templates/state.md`.
