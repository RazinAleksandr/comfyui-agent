...
<execution_context>
@/root/workspace/avatar-factory/.claude/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @/root/workspace/avatar-factory/.claude/get-shit-done/workflows/forensics.md end-to-end.
</process>
